          ...
          <div class="max-w-3xl mx-auto lg:max-w-none">
            ...
            <article>
              ...
              <header class="max-w-3xl mx-auto mb-20">
                <!-- Title -->
                <h1 class="h1 text-center mb-4">Redesigning your project, what are the steps there?</h1>
              </header>
              ...
              <div class="lg:flex lg:justify-between" data-sticky-container>
                ...
                <div>
                  ...
                  <div class="text-lg text-gray-600">
                    ...
                    <figure class="mb-8">
                      <img class="w-full rounded" src="https://cdn.dribbble.com/users/3014645/screenshots/6454254/image.png" width="768" height="432" alt="Blog single" />
                    </figure>
                    ...
                    <p class="mb-8">
                      <a class="inline-flex items-center text-base text-blue-600 font-medium hover:underline" href="#0">
                        <span>Read Simple on-demand services</span>
                        <svg class="w-3 h-3 fill-current text-blue-400 shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h3 id="conclusion" class="h3 text-gray-900 mb-4" style="scroll-margin-top: 100px;">Conclusion</h3>
                    <p>
                    ...
                    <div>
                      ...
                      <div class="mt-6">
                        <router-link to="/articles" class="inline-flex items-center text-base text-blue-600 font-medium hover:underline">
                          <svg class="w-3 h-3 fill-current text-blue-400 shrink-0 mr-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                            <path d="M.293 5.282L5 .5l1.414 1.436-3 3.048H12v2.032H3.414l3 3.048L5 11.5.293 6.718a1.027 1.027 0 010-1.436z" />
                          </svg>
                          <span>Back to the articles</span>
                        </router-link>
                      </div>
                    </div>
                  </div>
